...
const unsigned char oled_asc2_12061[95][12]={
...
const unsigned char oled_asc2_16081[95][16]={
...
void OLED_ShowChar(u8 x,u8 y,u8 chr,u8 size,u8 mode)
{
    ...
    for(t=0;t<size;t++)
    {
		if(size==12)temp=oled_asc2_12061[chr][t];  //调用1206字体
		else temp=oled_asc2_16081[chr][t];		 //调用1608字体
        for(t1=0;t1<8;t1++)
		{
